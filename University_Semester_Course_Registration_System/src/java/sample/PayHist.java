...
public class PayHist extends HttpServlet 
{
...
"</head>");
            out.println("<body>\n" +
"<div id=\"first\">\n" +
"<h1><b>FEE PAID STUDENTS </b></h1>\n" +
"<table border=\"1\">\n" +
"<tr>\n" +
"<th><b><center>STUDENT ID</center></b></th>\n" +
"<th><b><center>STUDENT NAME</center></b></th>\n" +
"</tr>");
            ResultSet qs= st.executeQuery("select sid,sname from stu where sid in(select sid from payment) and branch="+"'"+bn+"'"+"and years="+"'"+ye+"'"+"and sem="+"'"+sem+"'");
            while(qs.next())
            {
                out.println("<tr>\n" +
