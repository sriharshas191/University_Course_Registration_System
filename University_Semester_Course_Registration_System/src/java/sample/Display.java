...
"</tr>");
            ResultSet qs= st.executeQuery("select *from course where branch="+"'"+bn+"'"+"and years="+"'"+ye+"'"+"and sem="+"'"+se+"'");
            while(qs.next())
            {
                out.println("<tr>\n" +
"<td><b><center>"+qs.getString(1)+"</center></b></td>\n" +
"<td><b><center>"+qs.getString(2)+"</center></b></td>\n" +
"<td><b><input type=\"checkbox\" name=\"course\" value="+""+qs.getString(1)+""+" checked></b></td>\n" +
"<tr>");
            }
            out.println("</table>\n" +
