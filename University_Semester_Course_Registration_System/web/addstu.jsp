<%-- 
    Document   : addstu
    Created on : 10-Aug-2022, 2:09:31 am
...
<html>
    ...
    <body background-color:#DBF9FC;>
        <div id="first">
            <form action="AdStu" method="post">
                <h1><b>ADD STUDENT </b></h1>
                <label class="one">
                    <span><b>STUDENT NAME :</b></span>&nbsp;
                    <input class="studentname" name="sna" type="text" required>
                </label>
                <label class="two">
                    <span><b>REGISTRATION NUMBER :</b></span>&nbsp;
                    <input class="registration number" name="snu" type="text" required>
                </label>
                <label class="three">
                ...
                <input class="submit" name="dsubmit" type="submit" value="ADD">
            </form>
        </div>
    </body>
</html>
