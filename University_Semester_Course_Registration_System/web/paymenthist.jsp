<%-- 
    Document   : paymenthist
    Created on : 10-Aug-2022, 2:18:54 am
...
<html>
    ...
    <body background-color:#DBF9FC;>
        <div id="first">
            <form action="PayHist" method="post">
                ...
                <label class="four">
                    ...
                    %>
                    <input type="text" name="bnch" value="<%=bn%>" readonly>
                </label>
                <label class="five">
                    <span><b>YEAR :</b></span>&nbsp;
                    <br>
                ...
                <input class="submit" name="dsubmit" type="submit" value="check">
            </form>
        </div>
    </body>
</html>
